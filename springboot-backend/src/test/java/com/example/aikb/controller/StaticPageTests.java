...
class StaticPageTests {
    ...
    void indexPageShouldBeServedWithVueWorkspace() throws Exception {
        mockMvc.perform(get("/index.html"))
                ...
                .andExpect(content().string(containsString("normalizedJobDeliveryPackageResult")))
                ...
                .andExpect(content().string(containsString("authForm")))
                .andExpect(content().string(containsString("isAuthenticated")))
                .andExpect(content().string(containsString("Authorization")))
                .andExpect(content().string(containsString("login")))
                .andExpect(content().string(containsString("logout")))
                .andExpect(content().string(containsString("jobAttachmentFile")))
                .andExpect(content().string(containsString("jobDeliveryPackageResult")))
                ...
                .andExpect(content().string(containsString("/api/job-agent/analyze-from-file")))
                ...
                .andExpect(content().string(containsString("generateJobDeliveryPackage")))
                .andExpect(content().string(containsString("analyzeJobFromAttachment")))
                .andExpect(content().string(containsString("onJobAttachmentChange")))
                ...
                .andExpect(content().string(containsString("exportJobDeliveryPackageReport")))
                ...
                .andExpect(content().string(containsString("job-delivery-package.md")))
